<template>
    ...
    >
        <template v-if="props.icon">
            <img :src="props.icon" alt="icon" class="w-full h-20 object-contain">
        </template>
        <template v-else>
            <svg xmlns="http://www.w3.org/2000/svg" class="w-full h-20 object-contain" viewBox="0 0 96 96" :fill="props.color ?? '#FFF'">
